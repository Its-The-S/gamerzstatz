    ...
    return (
        <div>
            <footer className="df footer">
                ...
                {/* footer card for aidan */}
                <div className="footer-card lg">
                    <h6>Aidan Chamberlain</h6>
                    <a href="https://www.linkedin.com/in/aidan-chamberlain-776b8b90/" className="" target="_blank">
                        <i className="fa fa-linkedin px-1" />
                    </a>
                ...
                {/* footer card for maya */}
                <div className="footer-card lg">
                    <h6>Maya Tillman</h6>
                    <a href="https://www.linkedin.com/in/maya-tillman-430084227/" className="" target="_blank">
                        <i className="fa fa-linkedin px-1" />
                    </a>

      ...
      >
        ...
        <SplideSlide>
          ...
          <p>
            Read the review on{" "}
            <a
              href="https://www.ign.com/articles/2018/10/20/call-of-duty-black-ops-4-review"
              target="_blank"
            >
              IGN
            </a>
          ...
          <p>
            See who is streaming it on{" "}
            <a
              href="https://www.twitch.tv/directory/game/Call%20of%20Duty%3A%20Black%20Ops%204"
              target="_blank"
            >
              Twitch
            </a>
        ...
        <SplideSlide>
          ...
          <p>
            Read the review on{" "}
            <a
              href="https://www.ign.com/articles/2009/05/05/plants-vs-zombies-review-4"
              target="_blank"
            >
              IGN
            </a>
        ...
        <SplideSlide>
          ...
          <p>
            Read the review on{" "}
            <a
              href="https://www.ign.com/articles/2015/06/19/batman-arkham-knight-review"
              target="_blank"
            >
              IGN
            </a>
          ...
          <p>
            See who is streaming it on{" "}
            <a
              href="https://www.twitch.tv/directory/game/Batman:%20Arkham%20Knight"
              target="_blank"
            >
              Twitch
            </a>
